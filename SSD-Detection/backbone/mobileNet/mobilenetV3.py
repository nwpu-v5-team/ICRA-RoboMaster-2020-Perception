...
@BackBone.register("mobileNet-V3")
class MobileNetV3_Large(nn.Module):
    def __init__(self, num_classes=1000, ssd_body=True):
        ...
        self.bneck = nn.Sequential(
            ...
            #Block(3, 24, 72, 24, nn.ReLU(inplace=True), None, 1), #####7777
        ...
        self.lateral_list = nn.ModuleList(
            [
                nn.Conv2d(672, 128, 3, stride=1, padding=1),
                nn.Conv2d(960, 128, 3, stride=1, padding=1),
    ...
    def forward(self, x):
        ...
        for i in range(len(outs)):
            laterals.append(self.lateral_list[i](outs[i]))
