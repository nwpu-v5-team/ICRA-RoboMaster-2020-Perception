...
#ifndef ICRA_VISION_BUFFERMANAGER_H
#define ICRA_VISION_BUFFERMANAGER_H
...
public:
    ...
    void dumpBuffer(std::ostream& os, const std::string& tensorName)
    {
        ...
        switch (mEngine->getBindingDataType(index))
        {
            ...
            case nvinfer1::DataType::kHALF: print<half>(os, buf, bufSize, rowCount); break;
            case nvinfer1::DataType::kINT8: break;
...
#endif //ICRA_VISION_BUFFERMANAGER_H
